export const manualStrikeOLM = [
  ...
  { inputs: [], name: 'OLM_ZeroBalance', type: 'error' },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'uint48', name: 'epoch_', type: 'uint48' },
      {
        indexed: false,
  ...
  {
    inputs: [
      { internalType: 'uint48', name: 'timeUntilEligible_', type: 'uint48' },
      {
        internalType: 'uint48',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'strikePrice_', type: 'uint256' },
    ],
    name: 'setStrikePrice',
    outputs: [],
    stateMutability: 'nonpayable',
